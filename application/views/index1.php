...
<div id="center">
    <div class="container" style="padding: 0 5px;">
        <div class="row">
            <div class="content media col-sm-12">
                <div class="customtab">
                    <h3 class="productblock-title vender"><a href="#tab-vendor" onclick="fn_view_more_product('Vendor','tab-vendor')">Latest Shops</a></h3>
...
?>
				...
				<div class="col-sm-4 col-xs-6" style="padding-bottom:10px;">
					<div class="profile-card carde rounded-lg shadow  text-center position-relative overflow-hidden">
						<div class="">	<img src="<?php echo base_url('public/image/images.jpg'); ?>"  alt="#"></div>
						<img src="<?php echo base_url('public/image/team2.jpg'); ?>"  alt="#" class="img-circle mx-auto mb-3">
						<h3 class="mb-4"><?php echo $v_shop['category_id']; ?></h3>
						<div class="text-left mb-4">
							<p class="mb-2"><i class="fa fa-envelope mr-2"></i> <?php echo $v_shop['v_shop_name']; ?></p>
							
						</div>
						<button class="btn btn-default" onclick="location.href='category?vendor_id=<?php echo strtr(base64_encode($val['vendor_id']),'+/=', '._-'); ?>'" style="margin:10px 0px 10px 0px;">Shop</button>
					</div>
				</div>
				<?php } } } }} ?>
				
			<div class="viewmore">
                            <div class="btn">View More Specials Seller</div>
                        </div>	
