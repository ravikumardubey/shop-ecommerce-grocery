        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Faq List
                        </span> - List</h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="announcement_group" class="breadcrumb-item">Faq List</a>
                    </div>
                    <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"> <span id="add_edit_span"> </span> Faq List </h5>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" placeholder="Enter Faq Category"
                                                   class="form-control required" id="faq_cat" name="faq_cat">
                                        </div>
                                        
                                        <div class="col-sm-6">
                                            <label>Description</label>
                                            <textarea type="textarea" placeholder="Enter Description"
                                                   class="form-control required" id="description" name="description"></textarea>
                                        </div>
...
$(document).ready(function() {
     $('#page_form_id').load('<?php echo base_url(); ?>faq'); 
...
function fn_add() {
    ...
    if (valid) {
      ...
      data['action'] = 'insert_data';
        data['t_code'] = '17';
        data['faq_cat'] = $("#page_form_id #faq_cat").val();
...
function fn_edit_popup(id) {
    ...
    var data_json = $.parseJSON(json_div);
            ...
            $("#page_form_id #faq_cat").val(data_json[0].faq_cat);
