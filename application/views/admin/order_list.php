        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Announcement Group
                        </span> - List</h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="announcement_group" class="breadcrumb-item">Announcement Group</a>
                    </div>
                    <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-header header-elements-inline">
                    ...
                    <h5 class="card-title">Announcement Group List</h5>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"> <span id="add_edit_span"> </span> Announcement Group </h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label>Name</label>
                                            <input type="text" placeholder="Enter Announcement Group Name"
...
function ajax_function_list() {
    $('.load_container').show();
    var data = {};
    data['action'] = 'announcement_group_list';
    $(document).ready(function() {
        table_list('POST', 'ajax_call', data, 'html', 'html_listing_data', 'detailsList');
    });
}
...
function fn_add() {
    ...
    if (valid) {
        var data = {};
        data['action'] = 'announcement_group';
        data['name'] = $("#page_form_id #name").val();
        fn_ajax('POST', data, 'json', 'ajax_call', 'message_data');
        ajax_function_list();
    }
}
...
function fn_edit_popup(id) {
    ...
    data['id'] = id;
    data['t_code'] = '1';
    fn_ajax('POST', data, 'json', 'ajax_call', 'data_json_div');
